...
public class PuzzleState implements StateInformation{
	...
	/**
	 * We wont be having more than 4 operations
	 * We can slide tiles from 4 directions if hole is in middle, 
	 * Two directions if hole is at a corner 
	 * three directions if hole is in middle of a row
	 * 
	 * @return an ArrayList containing all of the successors for that state
	 */
	@Override
	public ArrayList<StateInformation> genSuccessors()
	{
		ArrayList<StateInformation> successors = new ArrayList<StateInformation>();
		int hole = getHole();
	 ...
	 */
	private void swapAndStore(int d1, int d2, ArrayList<StateInformation> s)
	{
