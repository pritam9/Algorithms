...
public class AStarSearch
{
	...
	{
		SearchNode root = new SearchNode(new EightPuzzleState(board,goal));
		...
		while (!q.isEmpty()) // while the queue is not empty
		{
			...
			// it.
			{
				...
				for (int i = 0; i < loopSize; i++)
				{
					...
					System.out.println("Final cost is - "+tempNode.getFCost());
					System.out.println("Hueristic cost is - "+tempNode.getHCost());
					System.out.println();
					System.out.println();
				}
